<%-- 
    Document   : frame4
    Created on : Dec 7, 2015, 11:46:10 AM
    Author     : Kerem
--%>
 ...
 background-image: linear-gradient(to bottom, #95b91a, #8bb41d);filter:progid:DXImageTransform.Microsoft.gradient(GradientType=0,startColorstr=#95b91a, endColorstr=#8bb41d);
    ...
    <body>
        ...
        <%
                ...
                PreparedStatement pStmt = conn.prepareStatement("select menuItemName,description from menuItem where menuItem.menuId = 1000001") ;
